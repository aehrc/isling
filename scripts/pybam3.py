'''
Based on the work of the authors listed below with minor changes by Felix Hartkopf
https://gitlab.com/HartkopfF 
https://github.com/TheBready
    ...
    def __init__(self,f,fields=False,decompressor=False):
        ...
        def generator():
            ...
            if magic == b'BAM\1':
                ...
                if decompressor != False and decompressor != 'internal':
