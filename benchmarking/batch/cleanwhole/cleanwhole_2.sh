...
#SBATCH --output=../../script_outputs/chr20_rerun/cleanwhole/300int/rep_2/integration_log.txt #standard error and output log
...
#SBATCH	--error=../../script_outputs/chr20_rerun/cleanwhole/300int/rep_2/integration_error.txt 		#error destination 
...
srun -N 1 art_illumina -ss HS25 -sam -i ../../script_outputs/chr20_rerun/cleanwhole/300int/rep_2/ints.fa -p -l 150 -f 20 -m 400 -s 15 -o ../../script_outputs/chr20_rerun/cleanwhole/300int/rep_2/paired_dat
